...
<head>
    ...
    <link rel="canonical" href="https://levelpm.vercel.app/blog/states/property-management-license-${s.slug}">
...
<head>
    ...
    <link rel="canonical" href="https://levelpm.vercel.app/blog/states/">
...
for (const s of states) {
  if (existingStates.includes(s.slug)) continue;
  console.log(`https://levelpm.vercel.app/blog/states/property-management-license-${s.slug}`);
}
